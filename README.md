...
![#f03c15] The total cost to build a quadcopter `#f03c15` like this is approximately $150 if you use the hardware list below. This includes a battery, transmitter, charger, etc.
