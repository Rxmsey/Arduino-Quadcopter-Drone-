...
void loop(){
  ...
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  Serial.println(F("IF YOU HAVE ANY ISSUE FEEL FREE TO ADD ME ON DISCORD: Ramsey#0605"));
  ...
  if(error == 0){
   ...
   Serial.println(F("Check the `Possible errors` file:"));
  }
  while(1);
}
